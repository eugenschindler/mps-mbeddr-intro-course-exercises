...
- 2026-08-22: STAGE 3 DONE (2026.1): all 5 at 261 (commits 1fdf136, c058968, 2ba76c3, da66c2b, ee10d28). mbeddr bumped to 2026.1.+. Language modules build for all 5 (`mops diagnose modules`; only `#generator` sub-modules NOT_BUILT — generators out of scope per user 2026-08-22: "as long as the language itself builds correctly, it's fine"). Model check vs 253 baseline: no regressions (Step3/Step4 models actually show FEWER errors at 261: 0 and 37->1 — allowed, fewer is fine).
- 2026-08-22: le-mps-course-materials embeds this repo as submodule langs/demo/mps-mbeddr-intro-course-exercises (was 898149e on all branches + HEAD). MUST bump gitlink per stage after exercise-repo stages complete: archive/mps20252 -> 4dc7685, archive/mps20253 -> 74c4a5e, feature/migrate-mps20261 -> ee10d28 (final stage tip).
