...
<solution name="IntegratedCExample.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#IntegratedCExample.__spreferences.PlatformTemplates" moduleVersion="0">
  <models>
